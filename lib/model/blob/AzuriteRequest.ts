...
class AzuriteRequest {
    ...
    createContainerRequest(containerName: string) {
        this.containerName = containerName;
    }

    createBlobRequest(blobName: string) {
    ...
    private _initMetaProps(rawHeaders: string[]) {
        this.metaProps = rawHeaders
            .map(this.removeXMsMeta)
    ...
    private removeXMsMeta(e: string, i: number, a: any) {
    ...
    private _initHttpProps(httpHeaders: {[key: string]: any }) {
        ...
        this.httpProps[N.ACCESS_CONTROL_REQUEST_METHOD] = httpHeaders["access-control-request-method"];
        this.httpProps[N.ACCESS_CONTROL_REQUEST_HEADERS] = httpHeaders["access-control-request-headers"];
