...
module.exports = (req, res, next) => {
    BbPromise.try(() => {
        ...
        validations[req.query.azuriteOperation](request, validationContext);
        next();
...
validations[Operations.Account.SET_BLOB_SERVICE_PROPERTIES] = (request, valContext) => {
    valContext
        .run(ServicePropertiesValidation);
}

validations[Operations.Account.GET_BLOB_SERVICE_PROPERTIES] = (request, valContext) => {
    // NO VALIDATIONS
}
